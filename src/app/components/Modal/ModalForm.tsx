    ...
    <Modal isOpen={props.isOpen} toggle={props.toggle}>
      <div className="flex flex-wrap md:flex-nowrap justify-between">
        <div className="mb-4 md:mb-0 basis-full md:basis-1/2">
          <h2 className="text-[32px] mb-[20px] md:w-[297px] text-textBlack dark:text-white font-medium">
        ...
        <div className="flex flex-col basis-full md:basis-1/2 h-[280px]  justify-between">
          <div className="h-[192px] flex gap-5 flex-col">
            <input
              className={
                "ModalFormInput dark:text-white dark:border-white h-[58px] items-start hover:pt-0 focus:pt-4 hover:placeholder:text-sm :transition-all ease-in-out duration-300"
              }
              placeholder={"Ваше Имя"}
            />
            <input
              className={
                "ModalFormInput dark:text-white dark:border-white h-[58px] center hover:pt-0 focus:pt-4 hover:placeholder:text-sm :transition-all ease-in-out duration-300"
              }
